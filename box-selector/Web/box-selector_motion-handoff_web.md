# Motion Handoff — Box Selector (Web)
...
Box Selector en Web usa motion de estados internos (sin enter/exit de viewport): default, hover, pressed, focus, disabled + control checked/unchecked.
