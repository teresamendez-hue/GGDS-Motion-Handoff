...
| Preview | Uso |
|---------|-----|
| [Preview App (HTML)](./checkbox_motion-handoff_app.html) | Spring simulado en JS con los mismos parámetros del Token Mapping. No sustituye QA en dispositivo. |
| [Preview Web companion](../Web/checkbox_motion-handoff_web.html) | Misma intención de motion. En App implementar con token spring, no curvas CSS. |
...
Checkbox en App usa estados internos animados con `motion-spring-sm`.
...
Checkbox dispara haptic en cambio de selección usando `haptic-selection-change`.
